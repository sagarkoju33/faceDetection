...
//     final String? response = await M7LivelynessDetection.instance
//         .detectLivelyness(
//           context,
...
//   //? =========================================================
//   AppBar _buildAppBar() {
//     return AppBar(title: const Text("M7 Livelyness Detection"));
//   }
...
//           ),
//         ),
//         Visibility(visible: _capturedImagePath != null, child: const Spacer()),
//         Center(
